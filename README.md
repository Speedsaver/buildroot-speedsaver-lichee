...
Download either a tarball of the latest buildroot LTS release (tested with Buildroot 2023.02.2 using longterm kernel 6.1.34 at the time of this writing), and extract it, or git  clone.
