...
Download either a tarball of the latest buildroot LTS release (tested with Buildroot 2022.02.8 LTS using stable kernel 6.0.12 at the time of this writing), and extract it, or git  clone.
